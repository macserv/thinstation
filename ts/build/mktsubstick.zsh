...
#    Default: "THINSTATION"
#
function mktsusbstick # --ts-repo <repo_path> --disk-id <disk_id> --new-volume-name [volume_name]
{
    ...
    umount -v ${DEV_SD_PATH}?* && sync
    eject     ${DEV_SD_PATH} || true
...
echo
echo "[INFO]  Function loaded.  Usage: # mktsusbstick --ts-repo <repo_path> --disk-id <disk_id> --new-volume-name [volume_name]"
echo
